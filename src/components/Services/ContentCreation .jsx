...
import { ArrowLeft, Moon, Sun, Camera, Video, Edit3, Megaphone, Play, Image as ImageIcon } from "lucide-react";
  ...
  const deliverables = [
    {
      ...
      title: "Ideating & Conceptualizing",
      description: "Creative brainstorming and strategic content planning for your brand"
    },
    {
      icon: <Camera className="w-8 h-8" />,
      title: "Photo & Video Shoots",
      description: "Professional photography and videography for high-quality content"
    },
    {
      icon: <Play className="w-8 h-8" />,
      title: "BTS Content Collection",
      description: "Behind-the-scenes content capture for authentic storytelling"
    },
    {
      icon: <ImageIcon className="w-8 h-8" />,
      title: "Reels & Stories Content",
      description: "Candid content shooting optimized for social media platforms"
    }
  ];
                ...
                <div className="flex items-center justify-center h-64 lg:h-80">
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-4 -right-8 bg-cyber-green/20 dark:bg-cyber-green/30 rounded-full p-3">
                      <Megaphone className="w-6 h-6 text-cyber-green" />
                    </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-lg lg:text-xl leading-relaxed text-light-text dark:text-dark-text">
                  Every campaign, every social media trend, and every new launch is an opportunity to 
