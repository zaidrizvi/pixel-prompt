...
import { ArrowLeft, Moon, Sun, Star, Users, Trophy, Zap, Play, Award } from "lucide-react";
  ...
  const deliverables = [
    {
      ...
      title: "Celebrity Selection & Sourcing",
      description: "Strategic celebrity matching aligned with your brand identity and target audience"
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Contract Negotiations",
      description: "Professional negotiation and contract management for celebrity partnerships"
    },
    {
      icon: <Trophy className="w-8 h-8" />,
      title: "Campaign Strategy & Execution",
      description: "End-to-end campaign planning and flawless execution management"
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: "Brand Ambassador Programs",
      description: "Long-term celebrity partnerships for sustained brand credibility and impact"
    }
  ];
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-lg lg:text-xl leading-relaxed text-light-text dark:text-dark-text">
                  We offer powerful Celebrity Marketing solutions backed by our strong network 
                  across the Bollywood and entertainment industry. Whether you're launching a new 
                  product or building brand credibility, we help you choose the right face that 
