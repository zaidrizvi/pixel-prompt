...
const WhatWeDo = () => {
  ...
  // Typewriter effect hook without cursor
  ...
  const highlightTypewriter = useTypewriter(messages[0].highlight, 30, 600);
  const descriptionTypewriter = useTypewriter(messages[0].description, 20, 700);
